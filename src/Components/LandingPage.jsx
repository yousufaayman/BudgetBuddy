...
export const LandingPage = () =>  {
  return (
    <ContainerStyled className="landing-page"  display = "grid" gridcolumns= "4fr 8fr 1fr" gridrows= "2fr 6fr" qlgridRows="1fr 5fr 1fr" qlgridColumns="1fr 3fr 2fr 1fr" qmgridRows="1fr 5fr 1fr" qmgridColumns="1fr 2fr 2f">
