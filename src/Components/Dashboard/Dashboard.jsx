...
export const Dashboard = () => {
    ...
    return (
        <ContainerStyled className="dashboard-page" display="grid" gridrows="1fr 10fr" gridcolumns="2fr 10fr 0.1fr" ql_height="100vh" ql_width="100vw" qm_height="100vh" qm_width="100vw">
